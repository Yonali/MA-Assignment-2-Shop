                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <form action="#" method="get" id="searchForm" class="input-group">
                                    <input type="search" class="form-control" name="search" placeholder="Search Orders..." onChange={(e) => {
                                ...
                                <br /><br />
                                {
                                    myOrders.map((element) => {
                                        return element.items.filter((val) => {
                                            if (search === "") {
                                                return val;
                                            } else if (
                                            ...
                                            return <div
                                                ...
                                                <div className="media d-block d-sm-flex text-center text-sm-left">
                                                    ...
                                                    <div className="media-body pt-3">
                                                        ...
                                                        <div className="font-size-lg text-primary pt-2">Delivery - Rs. {element.shippingFee}</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <h3 style={{ textAlign: 'center', paddingTop: '10px' }}
                                                        className="product-card-title font-weight-bold border-0 pb-0">Shipping
                                                        Status</h3>
                                                    <button className={element.status === 'Processing' ? "btn btn-primary btn-sm btn-block mb-2" : element.status === 'Shipped' ? "btn btn-warning btn-sm btn-block mb-2" : "btn btn-success btn-sm btn-block mb-2"}>{element.status}</button>
                                                </div>
                                            </div>
                                        })
                                    })
